...
#you will need to call this multiple times of course for each day directory in each sensor directory.
directory = "E:/Grassland/Shelburne/May/Sensor 1/20250505"
